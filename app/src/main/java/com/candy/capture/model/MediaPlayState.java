...
/**
 * Created by zhanghq on 2016/11/16.
 */
...
public enum MediaPlayState {
    ...
    /**
     * MediaPlayer调用setDataSource()方法就进入Initialized状态，表示此时要播放的文件已经设置好了。
     */
    INITIALIZED(2),
     ...
     * 如果播放完毕，而又设置了循环播放，则MediaPlayer仍然会处于Started状态，
    ...
    /**
     * Started或者Paused状态下均可调用stop()停止MediaPlayer，
     * 而处于Stop状态的MediaPlayer要想重新播放，需要通过prepareAsync()和prepare()回到先前的Prepared状态重新开始才可以。
     */
    STOPPED(7),
